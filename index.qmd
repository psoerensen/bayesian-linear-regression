...
| [**Bayesian Fine-Mapping with BayesC — Slides**](slides/bayesian_fine_mapping_bayesc_slides.html) | Lecture slides on joint BayesC fine-mapping, LD, PIPs, local credible sets, and annotation-informed priors. |
