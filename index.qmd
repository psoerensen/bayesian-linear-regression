...
| **Section** | **Description** |
|--------------|----------------|
| [**BLR notes**](notes/notes.html) | Theoretical notes on Bayesian linear regression, Gibbs sampling, and convergence diagnostics. |
| [**BLR slides**](slides/bayesian_linear_regression_slides.html) | Lecture slides summarizing key theoretical concepts and derivations in Bayesian Linear Regression Analyses. |
| [**BLR-GSEA slides**](slides/advanced_bayesian_linear_regression_slides.html) | Lecture slides introducing Bayesian Linear Regression Models used in Gene Set Analyses. |
| [**Bayesian MAGMA slides**](slides/bayesian_magma_slides.html) | Lecture slides introducing Gene Set Analyses using Bayesian MAGMA Models. |
| [**Bayesian Fine-Mapping with BayesC — Slides**](slides/bayesian_fine_mapping_bayesc_slides_final.html) | Lecture slides on joint BayesC fine-mapping, LD, PIPs, local credible sets, and annotation-informed priors. |
| [**Classical Regression tutorial**](tutorials/classical_linear_regression_simulation.html) | Simulation and estimation using ordinary least squares (OLS) in R. |
| [**Bayesian (Gaussian Prior)  tutorial**](tutorials/bayesian_linear_regression_conjugate.html) | Bayesian regression with conjugate Gaussian priors and closed-form Gibbs sampling in R. |
| [**Bayesian (Spike & Slab)  tutorial**](tutorials/bayesian_spike_and_slab.html) | Bayesian regression with spike-and-slab priors for variable selection and sparsity in R. |
| [**Bayesian MAGMA tutorial**](tutorials/bayesian_magma_tutorial.html) | Bayesian gene set analysis in R. |
| [**Bayesian Fine-Mapping with BayesC — Tutorial**](tutorials/bayesian_fine_mapping_bayesc.html) | Reproducible 30-SNP BayesC fine-mapping example using simulated phenotype data. |

[Download Notes (PDF)](notes/notes.pdf)  
[Download Data](data/genotypes.txt)  
[Download Slides (PDF)](slides/bayesian_linear_regression_slides.pdf)
...
[**Slides introducing the *qgg* and *gact* R packages**](slides/introduction_gact_qgg_slides.html)
